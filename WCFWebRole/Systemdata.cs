...
namespace WCFWebRole
{
    public class Systemdata
    {
        ...
        //    health = string.Format("{0}Version: {1}", Environment.NewLine, versionInfo.Version_String);
        //    health = string.Format("{0}{1}Build Version: {2}", Environment.NewLine, health, versionInfo.Build_Version);
        //    return health;
        //}
